...
obj = Check_start()
obj.create_divar_tables()
all_data = obj.readmodel()

for data in all_data:
    brand = data[1]
    model = data[2].replace(data[1],'')
    tip = data[3].replace(data[2],'')
    
    obj.insert_divar_model(brand,model,tip)



# f = open('divar_brand_model_tip.json',encoding='utf-8')
# data = json.load(f)
...
#                 for tip in tips:
#                     tip_a = tip['enumName']
#                     obj.insert_divar_model(brand_a,model_a,tip_a)
#             else:
#                 tip_a = ''
#                 obj.insert_divar_model(brand_a,model_a,tip_a)
#     except:
